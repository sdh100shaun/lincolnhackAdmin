...
<main id="content" role="main">
    ...
    <div class="container-fluid what" id="what">
        <div class="container">
            <div class="row">
                <div class="col-md-12">
                    <button class="btn btn-default text-uppercase" data-toggle="modal" data-target="#ticketsModal"><strong>Tickets</strong></button>
                    ...
                    <div class="embed-responsive embed-responsive-16by9">
                        ...
                        <video class="embed-responsive-item" preload="auto" autostart="0" loop="loop">
                            <source src="/videos/lincoln-hack-test.mp4" type="video/mp4">
                        </video>
                    </div>
                </div>
            </div>
            ...
            <div class="row">
                <div class="col-sm-6">
                    <p>LincolnHack is a FREE 24 hour coding competition where teams of up to four people compeate for fantastic prizes. Everyone starts with an idea and builds it in to something. Hardware hacks, software hacks, games, API mash-ups, funny things, arty things, wierd things, noisy things... whatever you decide to create, you’ve got 24 hours to do it!</p>
                </div>
                <div class="col-sm-6">
                    <p>LincolnHack, now in it's third year! We plan to keep the same great atmosphere, fun and mix of people. From students to veterans all are welcome. If your interested in tech, willing to build something and enjoy meeting like-minded people, we're sure you will enjoy yourself!</p>
                </div>
            </div>

            <div class="row">
                <div class="col-sm-12">
                    <h4>LincolnHack is a <strong class="text-uppercase">FREE</strong> event, so there's no excuse not to come along...</h4>
                </div>
            </div>
        </div>
    </div>
        ...
        <div class="container">
            <div class="row">
                <div class="col-md-12">
                    ...
                    <p class="text-center">LincolnHack would not be possible without  our sponsors,<br>we offer three tiers of sponsorship…</p>
                </div>
            </div>
    ...
    <div class="container-fluid digital-lincoln" id="digitaLincoln">
        <div class="container">
            ...
            <div class="row">
                <div class="col-sm-6">
                    <h5>Digital Lincoln is a community of people interested in technology and the digital world.</h5>
                    <p><br>We're a friendly bunch, open to all ages and technical abilities. We aim to build the tech community here in Lincoln, sharing ideas and knowledge through a schedule of informal events and socials.</p>
                </div>
...
<footer>
    <div class="container-fluid">
        <div class="row">
            ...
            <div class="col-md-8">
                <p class="text-center">LincolnHack follows the standard code of conduct as written by <a href="hackcodeofconduct.org">hackcodeofconduct.org</a>. LincolnHack is a fun event - help us to keep it fun by behaving appropriately<br>Copyright LincolnHack 2018. LincolnHack is run by members of Digital Lincoln</p>
            </div>
        </div>
    </div>
</footer>
...
<script async src="https://code.jquery.com/jquery-3.1.0.min.js" integrity="sha256-cCueBR6CsyA4/9szpPfrX3s49M9vUU5BgtiJj06wt/s=" crossorigin="anonymous"></script>
<script async src="https://maxcdn.bootstrapcdn.com/bootstrap/3.3.7/js/bootstrap.min.js" integrity="sha384-Tc5IQib027qvyjSMfHjOMaLkfuWVxZxUPnCJA7l2mCWNIpG9mGCD8wGNIcPD7Txa" crossorigin="anonymous"></script>

<!-- Fonts Here -->
<link href="https://fonts.googleapis.com/css?family=Raleway:300,400,500,600,700" rel="stylesheet">

<script async defer src="https://maps.googleapis.com/maps/api/js?key=AIzaSyD7C_xfL1ftPNavF8PQ9Qvd702D_yEzb1E&callback=initMap"></script>
