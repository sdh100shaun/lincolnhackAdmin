...
@include('partials.message')
        ...
        <div class="container">
            <div class="row">
                <div class="col-sm-5" id="js-what-is-lincolnHack">
                    ...
                    <p>LincolnHack is a FREE event. There is no excuse not to come along...</p><a class="btn lincolhack-flat-button" href="https://www.eventbrite.com/e/lincolnhack-ii-tickets-33165401609">GET TICKETS NOW!</a>
                </div>
                <div class="col-sm-5 col-sm-offset-2"><img alt="Scenes for the first LincolnHack" class="img-responsive img-promo" src="images/promo-1400x1415.png"></div>
            </div>
        </div>
    </div>
    ...
    <div class="wrapper wrapper--grey wrapper--no-margin">
        <div class="container">
            <div class="row">
                <div class="col-sm-5"><img alt="Scenes for the first LincolnHack" class="img-responsive img-promo" src="images/promo-img-1400x1403.png"></div>
    ...
    <div class="wrapper wrapper--grey wrapper--no-margin">
        <div class="container">
          ...
          LN6 7DJ
                    ...
                    <p><a class="twitter-follow-button" data-size="large" data-show-count="false" href="https://twitter.com/techlincs">@Techlincs </a></p>
                </div>
                <div class="col-sm-5 col-sm-offset-2">
                ...
                <div class="col-sm-5 col-sm-offset-2">
                    ...
                    <div id="mc_embed_signup">
                        <form action="//lincolnhack.us13.list-manage.com/subscribe/post?u=9363c6282f6b2b8e8f6e06302&amp;id=b80ea51571" method="post" id="mc-embedded-subscribe-form" name="mc-embedded-subscribe-form" class="validate" target="_blank" novalidate>
        ...
        <div class="container">
            <div class="row">
                ...
                <div class="row sponsors">
                    ...
                    <div class="sponsor big">
                        <a href="http://www.kryptokloud.com/" target="_blank"><img alt="Kryptokloud" src="images/KryptoKloud.png"></a>
                    </div>
                    <div class="sponsor big">
                        <a href="http://www.blueprintgaming.com/" target="_blank"><img alt="Blueprint gaming" src="images/Blueprint-Logo.png"></a>
                    </div>
                </div>
            ...
            <div class="row">
                <div class="col-sm-12">
                    ...
                    <div class="panel-group" id="accordion" role="tablist">
                        ...
                        <div class="panel panel-default">
                            <div class="panel-heading" role="tab">
                                <h4 class="panel-title"><a class="collapsed" data-parent="#accordion" data-toggle="collapse" href="#c10" role="button">Am I expected to stay up all night?</a></h4>
                            </div>
