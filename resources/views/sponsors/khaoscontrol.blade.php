        ...
        <div class="row">
            <div class="col-sm-12">
                <div class="center-block sponsor-page">
                    <img width="95%" src="../../images/assets/sponsors/KC_black_text.svg" alt="Khaos Control" />
                </div>
            <hr />
            </div>
        </div>
    ...
    <div class="container">
        ...
        <div class="row">
            <div class="col-sm-6">
                ...
                <p><a href="https://www.khaoscontrol.com">
                        Find out more at https://www.khaoscontrol.com
                    </a></p>
            </div>
