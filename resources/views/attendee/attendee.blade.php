        ...
        <div class="row">
            ...
            <div class="col-md-4 col-md-offset-0 col-md-push-4 col-sm-10 col-sm-offset-1">
                    ...
                    <ul class="list-unstyled sponsor-list">
                        ...
                        <li><a href="../../sponsors/gold/recap"><img src="../../images/assets/sponsors/recap-io.svg" alt="Recap.io" /></a>
                        </li>

                    </ul>


                <p> Also please check out our <a href="../../sponsors/silver/cooperpress">Silver sponsors</a> , without which the event would not happen.</p>
                <div class="flex-container text-center">
                    <div class="flex-item">
                   <img width="150px" src="/images/assets/sponsors/streetsheaver.svg" alt="Streets Heaver" />
                    </div>
               <div class="flex-item"> <img width="150px" src="../../images/assets/sponsors/selenity.svg" alt="Selenity" />
               </div>
                        <div class="flex-item"><img width="150px" src="../../images/assets/sponsors/cooperpress.svg" alt="Cooper Press" />
                        </div>
